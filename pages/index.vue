  ...
  <div class="min-h-screen text-white relative">
    ...
    <div class="max-w-[1240px] mx-auto px-6 pt-16 pb-16">
      <a href="https://www.spade.be" aria-label="Retour à l'accueil" class="block w-fit mb-10">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="121 68 174 50" aria-hidden="true" class="h-7 w-auto">
    ...
    <footer class="max-w-[1240px] mx-auto px-6 pt-12 pb-10">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
        ...
        <p class="text-sm text-[#898994]">
          Réalisé par Spade avec
          <a href="https://nuxt.com/" target="_blank" rel="noopener" class="text-white/60 hover:text-white transition-colors">Nuxt</a>,
          <a href="https://ui.nuxt.com/" target="_blank" rel="noopener" class="text-white/60 hover:text-white transition-colors">NuxtUI</a>
          et
          <a href="https://claude.ai/" target="_blank" rel="noopener" class="text-white/60 hover:text-white transition-colors">Claude</a>
        </p>
      </div>
    </footer>
